  ...
  <div :data-theme="theme" class="app">
    ...
    <footer class="footer" role="contentinfo">
      <div class="footer__inner">
        <p class="footer__copy">&copy; {{ currentYear }} Sean Jones. All rights reserved.</p>
...
.navbar {
  ...
  display: flex;
  align-items: center;
  transition: background var(--transition-theme), backdrop-filter var(--transition-theme), border-color var(--transition-base), box-shadow var(--transition-base);
